...
export function Header() {
  ...
  const userIsAdmin = authState.user?.role === 'admin';
          ...
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link to="/" className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold text-red-800">Planificador</span>
              </Link>
            </div>
              ...
              <div className="ml-3 relative">
                <div>
                  ...
                  >
                    ...
                    <div className="h-8 w-8 rounded-full bg-red-100 flex items-center justify-center text-red-800 font-semibold">
        ...
        <div className="sm:hidden">
          <div className="pt-2 pb-3 space-y-1">
            ...
            {userIsAdmin && (
              <Link
                to="/admin"
                className="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:bg-gray-50 hover:border-red-500 hover:text-red-700 flex items-center"
                onClick={() => setIsMenuOpen(false)}
              >
          ...
          {authState.user ? (
            <div className="pt-4 pb-3 border-t border-gray-200">
              <div className="flex items-center px-4">
                <div className="flex-shrink-0">
                  <div className="h-10 w-10 rounded-full bg-red-100 flex items-center justify-center text-red-800 font-semibold">
                    {authState.user.nombre.charAt(0).toUpperCase()}
                  </div>
                </div>
                <div className="ml-3">
            ...
            <div className="pt-4 pb-3 border-t border-gray-200">
              <div className="flex items-center justify-center space-x-4 px-4">
                <Link
                  to="/login"
                  className="text-gray-500 hover:text-red-700 px-3 py-2 rounded-md text-base font-medium"
                  onClick={() => setIsMenuOpen(false)}
                >
                  Iniciar Sesión
                </Link>
                <Link
                  to="/register"
                  className="bg-red-600 text-white hover:bg-red-700 px-3 py-2 rounded-md text-base font-medium"
                  onClick={() => setIsMenuOpen(false)}
                >
                  Registrarse
                </Link>
